...
export const PERSONAS = [
  ...
  },
  {
    ...
    rate: 1.06,
    lines: {
      start: ['Na endlich, auf geht es!', 'Schluss mit Aufwärmen im Kopf, los!', 'Dann zeig mal, was du draufhast!', 'Na, ausgeschlafen? Dann los!', 'Genug geredet, jetzt wird geschwitzt!'],
      ...
      work: [
        'Na los, beweg dich!', 'Nicht so zaghaft!', 'Mehr als zuschauen musst du schon!',
        'Komm, keine Ausreden!', 'Schwitzt du, oder weinst du?', 'Na, schon müde?',
        'Stell dich nicht so an!', 'Ein bisschen mehr Tempo, ja?', 'Das war jetzt nicht alles, oder?',
        'Hey, aufwachen!', 'Du wolltest doch mal fit werden!', 'Jetzt aber zackig!',
        'Nicht schummeln, ich seh alles!', 'Geht da noch was? Aber sicher!', 'Halbe Sachen gibt es nicht!',
        'Deine Ausreden sind fitter als du!', 'Mehr Einsatz, weniger Drama!',
        'War das ein Seufzer oder ein Hilferuf?', 'Ich hab schon Schnecken mit mehr Tempo gesehen!',
        'Na, kommt da noch was aus dem Tank?', 'Komm, beeindruck wenigstens dich selbst!',
        'Jetzt zeig, dass das kein Versehen war!', 'Ein bisschen mehr Feuer, du Kerze!',
        'Schau nicht so, der Boden tut dir nichts!', 'Tempo, der Bus fährt auch ohne dich!',
        'Sieht aus, als würdest du verhandeln, einfach machen!', 'Weniger zappeln, mehr arbeiten!',
        'Du kannst mehr, ich weiß es und du weißt es!', 'Das Stöhnen heb dir fürs Finale auf!',
        'Locker bleibt das Gesicht, der Rest strengt sich an!', 'Sauber bleiben, nicht eiern!',
        'Hopp, die Couch läuft dir nicht weg!', 'Noch wackelt nur die Motivation, leg nach!',
        'Atme, sonst kippst du mir noch um!', 'Du bist besser als dein Jammern!',
        'Komm schon, das schaffst sogar du!', 'Erst den Helden geben, dann durchziehen, ja?',
        'Ein bisschen ächzen ist erlaubt, dann weiter!', 'Streng dich an, das Frühstück war auch nicht umsonst!',
        'Mehr Power, weniger Ausreden suchen!', 'Sieht solide aus, jetzt überrasch mich!',
      ],
      mid: [
        'Schneller, {name}, nicht einschlafen!', 'Na, schon müde? Stell dich nicht so an!',
        'Komm, {name}, das war nicht alles, oder?', 'Schwitzt du oder weinst du?',
        'Mehr Schwung, weniger Wackelpudding!', 'Deine Ausreden machen schon Pause, du nicht, {name}!',
        'Halbe Kraft reicht fürs Sofa, nicht für mich!', 'Komm, beeindruck wenigstens die Schnecke da hinten!',
        'Mehr Feuer, du Teelicht!', 'Atme, {name}, ich brauch dich noch!',
        'Weiter, {name}, Jammern zählt nicht als Sport!', 'Sieht gut aus, jetzt mach es auch gut!',
        'Nicht nachlassen, sonst lacht gleich die Couch!', 'Tempo, {name}, der Endspurt wartet!',
        'Du hast mehr im Tank, raus damit!', 'Noch kurz, dann darfst du angeben!',
      ],
      rest: [
        'Pause. Aber bild dir nichts drauf ein.', 'Verschnauf mal, Held vom Sofa.', 'Pause, du Glückspilz.',
        'Kurze Pause, nicht einnicken!', 'Wasser trinken, Tränen zählen nicht.',
        'Pause. Genieß es, gleich wird wieder gejammert.', 'Kurz durchatmen, dann wieder Drama.',
        'Pause, der Kühlschrank bleibt trotzdem zu.', 'Sammel dich, gleich geht es weiter.',
        'Kurze Pause, das Sofa lässt grüßen.', 'Atme, sonst hält die Pause länger als du.',
        'Ruh dich aus, der nächste Satz wartet schon.', 'Kurz Luft holen, gleich wird es wieder ernst.',
        'Pause, fast hättest du dich angestrengt.', 'Verschnauf, gleich legst du nach.',
        'Kurze Rast, danach keine Ausreden mehr.', 'Locker bleiben, der Spaß geht gleich weiter.',
        'Pause, danach zeigst du mir, was geht.', 'Schnauf durch, das Beste kommt noch.',
        'Kurz erholen, dann volle Show.',
      ],
      warn15: ['Noch fünfzehn Sekunden, dann darfst du jammern.', 'Fünfzehn Sekunden, halt durch.', 'Noch fünfzehn, jetzt bloß nicht schlappmachen.', 'Fünfzehn Sekunden, da geht noch was!'],
      finish: ['Geschafft! Und es lebt noch.', 'Fertig! War doch halb so wild, {name}.', 'Erledigt, sogar mit Stil, fast.', 'Geschafft. Nicht schlecht, das gebe ich zu.', 'Fertig, {name}. Das hast du dir verdient.'],
    },
  },
  {
    id: 'lena',
