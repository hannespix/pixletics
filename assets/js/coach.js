...
export const PERSONAS = [
  ...
  },
  {
    ...
    lines: {
      ...
      work:   [
        ...
        'Bewegt euch!', 'Kein Gejammer!', 'Volle Kraft, sofort!', 'Durchziehen!',
  ...
  },
  {
    ...
    lines: {
      ...
      again:  ['Noch ein Satz {ex} – volle Energie!', '{ex}, einmal noch, du Maschine!'],
      work:   [
        'Auf geht’s, du schaffst das!', 'Energie an!', 'Jetzt zeigen, was du draufhast!',
        'Vollgas!', 'Du bist eine Maschine!', 'Gib alles!', 'Jetzt ziehst du das durch!',
        'Energie hoch!', 'Das wird stark!', 'Zeig deine Stärke!', 'Du packst das!',
        'Lass es krachen!', 'Voller Einsatz, los!', 'Du bist in Fahrt!',
        'Beweg dich, Held!', 'Heute ist dein Tag!', 'Stärker als gestern!',
        'Komm, durchstarten!', 'Volle Kraft!', 'Geht richtig ab!', 'Jetzt richtig!', 'Hol dir das!',
      ],
      ...
      mid:    ['Auf geht’s, {name}, nicht schlappmachen!', 'Du bist stärker als du denkst!', 'Weiter, {name}, weiter!', 'Genau so, bleib dran!', 'Das sieht klasse aus!', 'Noch mehr Energie!'],
  ...
  },
  {
    ...
    lines: {
      ...
      again:  ['Nochmal {ex}? Tja, selber schuld.', '{ex}, die Zweite. Genießen!'],
      work:   [
        ...
        'Geht da noch was? Sicher!', 'Komm, zeig was du kannst!', 'Halbe Sachen gibt’s nicht!',
        'Ran an den Speck!', 'Zeig mal Muckis!', 'Auf geht’s, Sportskanone!', 'Nicht einrosten!',
      ],
      rest:   ['Pause. Aber bild dir nichts drauf ein.', 'Verschnauf mal, Held.', 'Pause – du Glückspilz.'],
      warn15: ['Noch 15 Sekunden, dann darfst du jammern.', 'Fünfzehn Sekunden, halt durch.'],
      mid:    ['Schneller, {name}, nicht einschlafen!', 'Na, schon müde? Stell dich nicht so an!', 'Meine Oma macht das schneller!', 'Komm, {name}, das war nicht alles, oder?', 'Schwitzt du oder weinst du?', 'Mehr Schwung!'],
  ...
  },
  {
    ...
    lines: {
      ...
      work:   [
        ...
        'Mega, weiter!', 'Du machst das spitze!', 'Voller Fokus, los geht’s!', 'Dranbleiben, super!',
      ],
